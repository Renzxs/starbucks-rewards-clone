    ...
    return (
        <div className='flex items-center gap-4'>
            ...
            <ul className='flex items-center gap-6 max-lg:hidden'>
                ...
                <li className='font-bold uppercase hover:text-Starbucks'><a href="index">Rewards</a></li>
            </ul>
...
function NavContainer() {
    ...
    return (
        <>
            ...
            <nav className={`absolute z-20 h-[100vh] w-[40%] max-md:w-[50%] max-sm:w-[60%] pl-10 lg:hidden max-lg:text-[15px] bg-white transition-all duration-100 ease-in  ${menuClicked ? 'right-[0px] ' : 'right-[-500px] '}`}>
